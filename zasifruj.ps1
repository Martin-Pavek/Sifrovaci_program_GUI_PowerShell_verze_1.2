...
# upraveno 26.10.2024
# prazdny matrix 10+62 vodorovne a 126 svisle
...
#echo $ff
$rnd_num = Get-Random -Minimum 0 -Maximum 255
#echo $rnd_num
...
# 31.10.2024
# prevede dec 0-255 do hexa 00-ff
...
#echo $hexa_znak" hex"
$reference_na_heslo+=$hexa_znak
# konec 31.10.2024

#$reference_na_heslo += [string] $rnd_num # zde stary verze 1.1
$heslo_pro_zazipovani += $matrix[$ff][$rnd_num]
}

Write-host -ForegroundColor Yellow $reference_na_heslo_dec
Write-host -ForegroundColor red $reference_na_heslo
...
$zip_file_comment+=$reference_na_heslo # zustava na prvni radku
